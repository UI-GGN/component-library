...
var css_248z$3 = ".text--small {\n  font-size: 10px;\n}\n.text--medium {\n  font-size: 14px;\n}\n.text--large {\n  font-size: 16px;\n}\n.text--h6 {\n  font-size: 20px;\n  font-weight: bold;\n}\n.text--h5 {\n  font-size: 24px;\n  font-weight: bold;\n}\n.text--h4 {\n  font-size: 28px;\n  font-weight: bold;\n}\n.text--h3 {\n  font-size: 32px;\n  font-weight: bold;\n}\n.text--h2 {\n  font-size: 36px;\n  font-weight: bold;\n}\n.text--h1 {\n  font-size: 40px;\n  font-weight: bold;\n}\n.bold{\n  font-weight: bold;\n}";
styleInject(css_248z$3);

var Typography = function (_a) {
    var _b = _a.textType, textType = _b === void 0 ? 'medium' : _b, text = _a.text;
    return React.createElement("span", { className: "text--".concat(textType) }, text);
};
...
var Card = function (_a) {
    var heading = _a.heading, subHeading = _a.subHeading, onSubmit = _a.onSubmit, tag = _a.tag;
    return (React.createElement("div", { className: 'card flex flex-column ' },
        React.createElement("div", { className: 'card--content' },
            React.createElement("div", { style: { display: 'flex', flexDirection: 'column' } },
                React.createElement("div", { style: { display: 'flex' } },
                    React.createElement(Typography, { text: heading, textType: 'h6' }),
                    tag && React.createElement("span", { className: 'card--content__tag' }, tag)),
                React.createElement(Typography, { text: subHeading, textType: 'large' }),
                React.createElement("img", { style: { maxWidth: '100%', height: 'auto' }, src: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8c25lYWtlcnxlbnwwfHwwfHw%3D&w=1000&q=80', alt: 'sneakers' }))),
        React.createElement("div", { className: 'card-cta' },
            React.createElement(Button, { onClick: onSubmit, label: 'Buy' }),
            React.createElement(Button, { onClick: onSubmit, label: 'Add to cart' }))));
};
...
var CustomCard = function (_a) {
    var heading = _a.heading, subHeading = _a.subHeading, onSubmit = _a.onSubmit, _b = _a.render, render = _b === void 0 ? function () { return React.createElement(React.Fragment, null); } : _b;
    return (React.createElement("div", { className: 'card flex flex-column ' },
        React.createElement("div", { className: 'card--content' },
            React.createElement("div", { style: { display: 'flex', flexDirection: 'column' } },
                React.createElement("div", { style: { display: 'flex' } },
